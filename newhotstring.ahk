#+h::  ; Shift Window H Key
; this is an updated script from someone in the autohotkey community
...
IfMsgBox, Yes, Edit
return
; new string replacements will be place here at the end of the file.